...
namespace ControlSoft {
    ...
    public partial class DataSetClientes : global::System.Data.DataSet {
        ...
        public partial class ClientesDataTable : global::System.Data.TypedTableBase<ClientesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public ClientesRow AddClientesRow(string codigo, string nombre, string giro, string rfc) {
        ...
        public partial class ClientesRow : global::System.Data.DataRow {
            ...
            public string giro {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("El valor de la columna \'giro\' de la tabla \'Clientes\' es DBNull.", e);
                    }
                }
                set {
            ...
            public bool IsgiroNull() {
                return this.IsNull(this.tableClientes.giroColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public void SetgiroNull() {
                this[this.tableClientes.giroColumn] = global::System.Convert.DBNull;
            }
...
namespace ControlSoft.DataSetClientesTableAdapters {
    ...
    public partial class ClientesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Clientes] ([codigo], [nombre], [giro], [rfc]) VALUES (@codigo," +
                " @nombre, @giro, @rfc);\r\nSELECT codigo, nombre, giro, rfc FROM Clientes WHERE (c" +
                "odigo = @codigo)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Clientes] SET [codigo] = @codigo, [nombre] = @nombre, [giro] = @gir" +
                "o, [rfc] = @rfc WHERE (([codigo] = @Original_codigo));\r\nSELECT codigo, nombre, g" +
                "iro, rfc FROM Clientes WHERE (codigo = @codigo)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT codigo, nombre, giro, rfc FROM dbo.Clientes";
            ...
            this._commandCollection[2].CommandText = "INSERT INTO Clientes\r\n                         (codigo, nombre, giro, rfc)\r\nVALUE" +
                "S        (@codigo,@nombre,@giro,@rfc); \r\nSELECT codigo, nombre, giro, rfc FROM C" +
            ...
            this._commandCollection[2].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@giro", global::System.Data.SqlDbType.VarChar, 2147483647, global::System.Data.ParameterDirection.Input, 0, 0, "giro", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[2].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@rfc", global::System.Data.SqlDbType.VarChar, 2147483647, global::System.Data.ParameterDirection.Input, 0, 0, "rfc", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[3] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[3].Connection = this.Connection;
            this._commandCollection[3].CommandText = "UPDATE [dbo].[Clientes] SET [codigo] = @codigo, [nombre] = @nombre, [giro] = @gir" +
                "o, [rfc] = @rfc WHERE (([codigo] = @Original_codigo));\r\nSELECT codigo, nombre, g" +
                "iro, rfc FROM Clientes WHERE (codigo = @codigo)";
            ...
            this._commandCollection[3].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@giro", global::System.Data.SqlDbType.VarChar, 2147483647, global::System.Data.ParameterDirection.Input, 0, 0, "giro", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[3].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@rfc", global::System.Data.SqlDbType.VarChar, 2147483647, global::System.Data.ParameterDirection.Input, 0, 0, "rfc", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        ...
        public virtual int Insert(string codigo, string nombre, string giro, string rfc) {
            if ((codigo == null)) {
        ...
        public virtual int Update(string codigo, string nombre, string giro, string rfc, string Original_codigo) {
            if ((codigo == null)) {
                throw new global::System.ArgumentNullException("codigo");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string nombre, string giro, string rfc, string Original_codigo) {
            return this.Update(Original_codigo, nombre, giro, rfc, Original_codigo);
        }
        ...
        public virtual int GuardarC(string codigo, string nombre, string giro, string rfc) {
            ...
            if ((giro == null)) {
                ...
                command.Parameters[2].Value = ((string)(giro));
            }
            if ((rfc == null)) {
                command.Parameters[3].Value = global::System.DBNull.Value;
            }
            else {
                command.Parameters[3].Value = ((string)(rfc));
            }
            global::System.Data.ConnectionState previousConnectionState = command.Connection.State;
            if (((command.Connection.State & global::System.Data.ConnectionState.Open) 
                        != global::System.Data.ConnectionState.Open)) {
        ...
        public virtual int ModificarC(string codigo, string nombre, string giro, string rfc, string Original_codigo) {
